...
export const TaskCard = ({
    ...
    return (
        <div className="h-56 text-base-content/70 rounded-0 rounded-bl-4xl rounded-tr-3xl rounded-tl-2xl  py-2 px-2 flex flex-col gap-2 bg-white/15!  border border-white/10  ">
